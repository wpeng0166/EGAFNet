...
class DSAM(nn.Module):
    def __init__(self, channels):
        ...
        self.pool_att = SpecAtte(channels)

                                          
                                     
        branch_channels = channels // 2
        self.cubic_11 = cubic_attention(branch_channels, group=1, kernel=11)
        self.cubic_7 = cubic_attention(branch_channels, group=1, kernel=7)
    ...
    def forward(self, x):
        ...
        out_chunk_1, out_chunk_2 = torch.chunk(out, 2, dim=1)
        
                                           
        out_11 = self.cubic_11(out_chunk_1)
        out_7 = self.cubic_7(out_chunk_2)
