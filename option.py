...
class Options():
    ...
    def init(self):
        ...
        self.parser.add_argument('--dataroot', type=str, default='/home/s_wp/workspace/data/')
        ...
        self.parser.add_argument('--vis_dir', type=str, default='checkpoints/SECOND/results', help='visualization results are saved here')           
        self.parser.add_argument('--vis_cols', type=int, default=8, help='number of columns in visualization grid')
        self.parser.add_argument('--load_pretrain', type=bool, default=False)
        self.parser.add_argument('--phase', type=str, default='train')
        self.parser.add_argument('--input_size', type=int, default=512)
        self.parser.add_argument('--backbone', type=str, default='mobilenetv2')
        self.parser.add_argument('--lge', action='store_true', help='LEGEnhanceBlock')
        self.parser.add_argument('--fdconv', action='store_true', help='FDConv')
        self.parser.add_argument('--arconv', action='store_true', help='ARConv')
        ...
        self.parser.add_argument('--test_batch_size', type=int, default=1, help='batch size for testing')
